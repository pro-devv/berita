          ...
          <div class="col-sm-12">
            <div class="card" data-aos="fade-up">
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-12">
                    <h1 class="font-weight-600 mb-4">TECHNOLOGY</h1>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-8">
                          ...
                          <div class="row">
                            <div class="col-sm-4 grid-margin">
                              <div class="rotate-img">
                                <a href="detail_berita.php?id=<?php echo $row['id']; ?>"><img src="<?php echo BASEURL; ?>/images/<?php echo $row['image']; ?>" alt="banner" class="img-fluid" /></a>
                              </div>
                            </div>
                  ...
                  <div class="col-lg-4">
                    ...
                    if (is_array($rows)) {
                      foreach ($rows as $row) {
                        if ($row['category'] == 'Technology' && $i <= 3) {
                    ?>
                          <div class="row">
                            <div class="col-sm-12">
                    ...
                    <div class="trending">
                      ...
                      if (is_array($rows)) {
                        foreach ($rows as $row) {
                          if ($row['category'] == 'Technology' && $i <= 2) {
                      ?>
                            <div class="mb-4">
                              <div class="rotate-img">
                                <a href="detail_berita.php?id=<?php echo $row['id']; ?>"><img src="../images/<?php echo $row['image']; ?>" alt="banner" class="img-fluid" /></a>
