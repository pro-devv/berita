...
<html lang="eng">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo BASEURL; ?>../../public/assets/vendors/mdi/css/materialdesignicons.min.css"/>
    <link rel="stylesheet" href="<?php echo BASEURL; ?>../../public/assets/vendors/aos/dist/aos.css/aos.css" />
    <link rel="shortcut icon" href="<?php echo BASEURL; ?>../../public/assets/images/logo.png" />
            ...
            <div class="row" data-aos="fade-up">
              ...
              <div class="col-xl-8 stretch-card grid-margin">
                <div class="position-relative">
                  <a href="detail_berita.php?id=<?php echo $row['id']; ?>"><img src="<?php echo BASEURL .'/images/' . $row['image']; ?>" alt="banner" class="img-fluid"/></a>
                  <div class="banner-content">
                    <div class="badge badge-danger fs-12 font-weight-bold mb-3"><?php echo $row['category'].' '; ?></div>
                    <a href="detail_berita.php?id=<?php echo $row['id']; ?>" style="text-decoration: none; color: white"><h1 class="mb-2"><?php echo $row['title']; ?></h1></a>
                    <div class="fs-12">
                ...
                <div class="card bg-dark text-white">
                  <div class="card-body">
                    ...
                    <div class="d-flex border-bottom-blue pt-3 pb-4 align-items-center justify-content-between">
                      <div class="pr-3">
                        <a href="detail_berita.php?id=<?php echo $row['id']; ?>" style="color: white"><h5><?php echo $row['title']; ?></h5></a>
                        <div class="fs-12">
                          <span class="mr-2"><?php echo $row['category']; ?></span><?php echo $row['date']; ?>
                        </div>
                      </div>
                      <div class="rotate-img">
                        <a href="detail_berita.php?id=<?php echo $row['id']; ?>"><img src="<?php echo BASEURL .'/images/' . $row['image']; ?>" alt="thumb" class="img-fluid img-lg"/></a>
                      </div>
                    </div>
                    <?php
                            $i++;
                  ...
                  <?php
                    ...
                    <div class="row">
                      <div class="col-sm-4 grid-margin">
                        <div class="position-relative">
                          <div class="rotate-img">
                            <a href="detail_berita.php?id=<?php echo $row['id']; ?>"><img src="<?php echo BASEURL . '/images/' . $row['image']; ?>" alt="thumb" class="img-fluid"/></a>
                          </div>
                      ...
                      <div class="col-sm-8  grid-margin">
                        <a href="detail_berita.php?id=<?php echo $row['id']; ?>" style="color: #016064"><h2 class="mb-2 font-weight-600"><?php echo $row['title']; ?></h2></a>
                      ...
                      <div class="col-xl-6">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xl-6 col-lg-8 col-sm-6">
                            ...
                            <a href="detail_berita.php?id=<?php echo $row['id']; ?>" style="color: black; text-decoration: none"><h2 class="mt-3 text-primary mb-2"><?php echo $row['title']; ?></h2></a>
                          ...
                          <div class="col-xl-6 col-lg-4 col-sm-6">
                            ...
                            <div class="border-bottom pb-3 mb-3">
                              <a href="detail_berita.php?id=<?php echo $row['id']; ?>" style="color: black; text-decoration: none"><h3 class="font-weight-600 mb-0"><?php echo substr($row['title'],0,20).'...'; ?></h3></a>
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            ...
                            <div class="border-bottom pb-3">
                              ...
                              <a href="detail_berita.php?id=<?php echo $row['id']; ?>" style="color: black; text-decoration: none"><p class="fs-16 font-weight-600 mb-0 mt-3"><?php echo $row['title']; ?></p></a>
                              <p class="fs-13 text-muted mb-0">
                                <span class="mr-2"><?php echo $row['category']; ?></span><?php echo $row['date']; ?>
                              </p>
                            </div>
                                ...
                                <div class="border-bottom pb-3">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-5 pr-2">
                                      <div class="rotate-img">
                                        <a href="detail_berita.php?id=<?php echo $row['id']; ?>"><img src="<?php echo BASEURL .'/images/' . $row['image']; ?>" alt="thumb"  class="img-fluid w-100"/></a>
                                      </div>
                                    </div>
                                    <div class="col-sm-7 pl-2">
                                      <a href="detail_berita.php?id=<?php echo $row['id']; ?>" style="color: black; text-decoration: none"><p class="fs-16 font-weight-600 mb-0"><?php echo substr($row['title'],0,15).'...'; ?></p></a>
                                      <p class="fs-13 text-muted mb-0">
                                        <span class="mr-2"><?php echo $row['category']; ?></span><?php echo $row['date']; ?>
                                      </p>
